...
Message: cover from MessageStruct* {
    ...
    new: static func ~withData (data: Pointer, size: SizeT, dealloc: Func (Pointer, Pointer), hint: Pointer) -> This {
        this := gc_malloc(MessageStruct size)
...
zmq_msg_init_data: extern func (Message, Pointer, SizeT, Func (Pointer, Pointer), Pointer)
